        ...
        <main>
            <div class="flex flex-col m-20">
                ...
                <section class="flex flex-col text-white  text-2xl mx-4 self-center py-5">
                    ...
                    <h1 class="font-bold text-center">Admin Register</h1>

                    <div class=" bg-slate-300 w-auto py-5 my-5 rounded-md">
                        <form action="registered" method="post" class="p-3 flex flex-col space-y-5">
                            @csrf
                            ...
                            <button type="submit" class=" bg-blue-500 p-3 w-auto self-center rounded-md hover:bg-blue-700">Register</button>
                        </form>
                    </div>
                </section>
            </div>
